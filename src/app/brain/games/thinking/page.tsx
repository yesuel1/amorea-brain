...
import { ThinkingGame } from "@/components/brain/games/ThinkingGame";
...
export default function ThinkingGamePage() {
  ...
  const handleComplete = (finalScore: number, finalDuration: number) => {
    ...
    trackGamePlay("thinking", finalScore);
  };
    ...
    <div className="min-h-screen pt-20 pb-8 px-4">
      <div className="max-w-mobile mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-vb-muted mt-1">패턴 찾기</p>
        </div>

        {!gameCompleted ? (
          <Card>
            <ThinkingGame onComplete={handleComplete} standalone />
          </Card>
        ) : (
      ...
      <ShareSheet
        ...
        title={`사고력 게임 ${score}점 달성!`}
        text={`AMOREA Brain Care 사고력 게임에서 ${score}점을 달성했어요! 🧠`}
        url={typeof window !== "undefined" ? window.location.origin + "/brain/games/thinking" : ""}
