...
export default function FocusGamePage() {
  ...
  const handleComplete = (finalScore: number, finalDuration: number) => {
    ...
    trackGamePlay("focus", finalScore);
  };
    ...
    <div className="min-h-screen pt-20 pb-8 px-4">
      <div className="max-w-mobile mx-auto">
        <div className="text-center mb-6">
          ...
          <p className="text-vb-muted mt-1">색 변화 감지 테스트</p>
        </div>

        {!gameCompleted ? (
          <Card>
            <FocusGame onComplete={handleComplete} standalone />
          </Card>
        ) : (
      ...
      <ShareSheet
        ...
        title={`집중력 게임 ${score}점 달성!`}
        text={`AMOREA Brain Care 집중력 게임에서 ${score}점을 달성했어요! 🎯`}
        url={typeof window !== "undefined" ? window.location.origin + "/brain/games/focus" : ""}
